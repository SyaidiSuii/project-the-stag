...
@section('title', 'Monthly Analytics Dashboard')
@section('page-title', 'Monthly Analytics Dashboard')
...
<div class="analytics-container">
    <div class="page-header">
        <div class="page-title-wrapper">
            <h2 class="page-title">Monthly Analytics Dashboard</h2>
            <p class="page-subtitle">Current month performance ({{ now()->format('F Y') }})</p>
        </div>
        <div class="header-actions">
            <a href="{{ route('admin.reports.all-time') }}" class="nav-btn">
                <i class="fas fa-chart-line"></i> View All Time Report
            </a>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        console.log('Monthly Analytics Dashboard Initialized');
