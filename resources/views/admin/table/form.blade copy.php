    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <section>
                ...
                @if($table->id)
                    <form method="post" action="{{ route('admin.table.update', $table->id) }}" class="mt-6 space-y-6">
                        <input type="hidden" name="_method" value="PUT">
                @else
                    <form method="post" action="{{ route('admin.table.store') }}" class="mt-6 space-y-6">
                ...
                @endif
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <a href="{{ route('admin.table.index', ['cancel' => 'true']) }}"
