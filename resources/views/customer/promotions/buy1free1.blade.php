...
<style>
    ...
    @media (min-width: 1600px) {
        .b1f1-container { max-width: 1500px; padding: 28px; }
    ...
    @media (max-width: 1199px) and (min-width: 769px) {
        ...
        .b1f1-badge { font-size: 13px; padding: 7px 14px; }
        ...
        .b1f1-items-grid { gap: 18px; }
        .b1f1-item { gap: 18px; padding: 18px; border-radius: 14px; }
    ...
    @media (max-width: 768px) {
        ...
        .b1f1-badge { font-size: 12px; padding: 6px 12px; margin-top: 12px; }
        ...
        .b1f1-items-grid { gap: 14px; }
        .b1f1-item { flex-direction: column; text-align: center; gap: 14px; padding: 16px; }
