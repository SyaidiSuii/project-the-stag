          ...
          <div class="booking-card-content">
            ...
            <div class="datetime-inputs">
              ...
              <div class="input-group">
                ...
                <input type="text" id="guestName" placeholder="Enter your full name" value="{{ auth()->user()->name ?? '' }}" required>
              </div>
              <div class="input-group">
                <label for="guestEmail">Email Address</label>
                <span class="input-icon"><i class="fas fa-envelope"></i></span>
                <input type="email" id="guestEmail" placeholder="Enter your email" value="{{ auth()->user()->email ?? '' }}" required>
              </div>
              <div class="input-group">
                <label for="guestPhone">Phone Number</label>
                <span class="input-icon"><i class="fas fa-phone"></i></span>
                <input type="tel" id="guestPhone" placeholder="Enter your phone number" value="{{ auth()->user()->phone_number ?? '' }}" required>
              </div>
            </div>
          </div>
        </div>
